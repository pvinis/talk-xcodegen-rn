...
- Done. You can now run `./ios/make` to have your Xcode project generated.
...
- adding a package with native code, how to link it with the yml.
-also self made native code



- show how xcode changes can be ported to yml
